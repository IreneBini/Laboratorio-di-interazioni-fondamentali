...
// Mon Feb 12 11:38:03 2024 by ROOT version 6.30/04
// from TTree rec/rec
// found on file: data_2000_140.root
//////////////////////////////////////////////////////////
...
#ifdef dati_cxx
dati::dati(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("data_2000_140.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("data_2000_140.root");
      }
...
Int_t dati::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t dati::LoadTree(Long64_t entry)
{
