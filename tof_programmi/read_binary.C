...
void decode(const char *filename) {
   ...
   int n_samples_min = 0;
   int scelta;
   cout << "Please enter the number of the events:" << endl;
	cin >> n_samples;

   if(n_samples>2000){
      cout << "Hai inserito un numero di eventi troppo alto. Quale multiplo di 2000 vuoi?" << endl;
      cin >> scelta;
      switch (scelta){
         case 1:
            n_samples = 2000;
         ...
         case 2:
            n_samples_min = 2000;
            if(n_samples>4000){n_samples=4000;}
            break;
         case 3:
            n_samples_min = 4000;
            if(n_samples>6000){n_samples=6000;}
            break;
         case 4:
            n_samples_min = 6000;
   ...
   cout << "Gli eventi che prende vanno da " <<  n_samples_min << " e " << n_samples << endl;
   sleep(10);
   // loop over all events in the data file
   for (n=n_samples_min; n<n_samples; n++) {
      // read event header
